...
I co-founded [Eternis](https://www.eternis.ai/) where we're building systems for forecasting, reasoning and decision-making under uncertainty. In the past, we also worked on secure LLM inference and private AI deployments.  More recently, my research focus has shifted to understanding and improving LLMs, particularly using reinforcement learning and other post-training techniques. First in this line of work is [this](https://arxiv.org/abs/2508.14094) paper on annotation-efficient GRPO post-training.
